...
class Bdd_sentence_maker:
    ...
    def get_total_sentence(self, color: str, car: str, time: str, bogus1: str, bogus2: str, bogus3: str, bogus4: str) -> str:
        ...
        return f"{color_sentence}&{car_sentence}&{time_sentence}"
...
execute_query("CREATE TABLE t_witnesses (id INTEGER, name TEXT, color TEXT, car TEXT, time TEXT, _sentence Bdd)")
execute_query("DROP TABLE IF EXISTS t_suspects")
execute_query("CREATE TABLE t_suspects (id INTEGER, name TEXT, color TEXT, car TEXT, time TEXT, _sentence Bdd)")
...
def insert_person(entry_count: int, person_type: person_type):
    ...
    for x in range(entry_count):
        ...
        entry.append((id, name, color, car, time))
        if person_type == person_type.WITNESS:
    ...
    for person in entry:
        ...
        sentence = bdd_makers[person[0]].get_total_sentence(person[2], person[3], person[4])
        ...
        cur.execute(f"INSERT INTO t_{'witnesses' if person_type == person_type.WITNESS else 'suspects'} (id, name, color, car, time, _sentence) VALUES (%s, %s, %s, %s, %s, Bdd('{sentence}'))", (person[0], person[1], person[2], person[3], person[4]))       
